...
// src/infrastructure/gh/gh-factory.ts
var GhFactory = class _GhFactory {
...
// src/infrastructure/git/git-factory.ts
var GitFactory = class _GitFactory {
  ...
  static make(terminalFactory) {
    return new _GitFactory(terminalFactory);
  }
};

// src/infrastructure/terminal/services/child-process-service.ts
var import_node_child_process = require("node:child_process");
var ChildProcessService = class {
  constructor(cwd) {
    this.cwd = cwd;
  }
  cwd;
...
// src/infrastructure/terminal/terminal-factory.ts
var TerminalFactory = class _TerminalFactory {
  constructor(cwd) {
    this.cwd = cwd;
  }
  cwd;
  ...
  static make(cwd) {
    return new _TerminalFactory(cwd);
  }
};

// src/core/services/bumpers/claude-bumper-service.ts
...
var ClaudeService = class {
  ...
  bump(version) {
    try {
      const pluginJson = (0, import_node_path2.join)(this.cwd, this.pluginDir, "plugin.json");
      const hasPlugin = (0, import_node_fs2.existsSync)(pluginJson);
      if (!hasPlugin) {
        return {
          ok: false,
      ...
      const marketplaceJson = (0, import_node_path2.join)(
        this.cwd,
        this.pluginDir,
        "marketplace.json"
      );
      const hasMarketplace = (0, import_node_fs2.existsSync)(marketplaceJson);
      if (!hasMarketplace) {
        return {
          ok: false,
      ...
      const plugin = JSON.parse((0, import_node_fs2.readFileSync)(pluginJson, "utf8"));
      ...
      if (plugin.version !== version) {
        ...
        (0, import_node_fs2.writeFileSync)(pluginJson, JSON.stringify(plugin, null, 2) + "\n");
      }
      const marketplace = JSON.parse((0, import_node_fs2.readFileSync)(marketplaceJson, "utf8"));
...
// src/core/services/bumpers/npm-bumper-service.ts
...
${lines.join("\n")}`);
  ...
  updateChangelog(tag, releaseNotes, changelogFile) {
    try {
      const path = (0, import_node_path3.join)(this.cwd, changelogFile);
...
`;
      if ((0, import_node_fs3.existsSync)(path)) {
        const existing = (0, import_node_fs3.readFileSync)(path).toString();
        (0, import_node_fs3.writeFileSync)(path, entry + existing);
      } else {
        (0, import_node_fs3.writeFileSync)(path, entry);
      }
      return { ok: true };
    } catch (error2) {
      return { ok: false, error: error2 };
...
// src/core/services/semver-service.ts
var import_node_fs4 = require("node:fs");
var import_node_path4 = require("node:path");
var SemverService = class {
  ...
  get(versionFile) {
    try {
      const path = (0, import_node_path4.join)(this.cwd, versionFile);
  ...
  set(version, versionFile) {
    try {
      const path = (0, import_node_path4.join)(this.cwd, versionFile);
      (0, import_node_fs4.writeFileSync)(path, `${version}
`);
      return { ok: true };
    } catch (error2) {
      return { ok: false, error: error2 };
  ...
  calculateNextVersion(versionFile, semantic) {
    ...
    if (!setVersion.ok) return { ok: false, error: setVersion.error };
    return {
      ok: true,
      data: {
...
var CoreFactory = class _CoreFactory {
  ...
  static make(cwd) {
    ...
    return new _CoreFactory(cwd, gitFactory, ghFactory, terminalFactory);
  }
};
...
// src/application/action/action-factory.ts
var CliFactory = class _CliFactory {
  ...
  static make(cwd) {
    ...
    return new _CliFactory(coreFactory);
  }
};
